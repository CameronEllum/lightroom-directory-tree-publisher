...
1. Copy the **DirectoryTreePublisher.lrplugin** folder into the Lightroom plugins folder (e.g., `C:\Program Files\Adobe\Adobe Lightroom Classic`) or add this plugin from Lightroom Plug-in Manager.
